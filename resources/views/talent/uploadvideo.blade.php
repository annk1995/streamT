@extends('talent.components.main')
@section('content')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="terms text-center">
                        <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority
                            <a href="#">Terms of Service</a> and <a href="#">Community Guidelines</a>.</p>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-6 col-sm-6">
                        <p class="mt-1 mb-0">© Copyright 2020 <strong class="text-dark">Vidoe</strong>. All Rights
                            Reserved<br>
